                ...
                <div className="collapse collapse-plus bg-base-200">
                    ...
                    <div className="collapse-content">
                        ...
                        <p className="mt-2">
                           ...
                           近傍イベントのスコア推移を、現在のイベントの直近20~60時間ほどのトレンドに合わせて調整しています。
                           現在のスコアの伸びが近傍イベントより遅い場合は、近傍の今後のスコア推移を少し下向きに、逆に早い場合は上向きに補正します。
                           これにより、現時点の傾向に合った柔軟な予測が可能になりますが、局部的なデータを元にした調整のため、実際の動きとはずれることもあります。
                        </p>
                        <p className="mt-2">
