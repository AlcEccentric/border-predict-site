        ...
        normalBlock = (
            <div className="mt-4">
                ...
                <div className="ml-4">
                    <p className="mt-2">
                        <strong>100位ボーダー:</strong>
                        <br />• イベント序盤（10-29%）: ±10%誤差範囲の的中率 12-19%、±5%誤差範囲 12-19%
                        <br />• イベント中盤（30-69%）: ±10%誤差範囲の的中率 18-43%、±5%誤差範囲 18-43%
                        <br />• イベント後半（70-79%）: ±10%誤差範囲の的中率 37-68%、±5%誤差範囲 37-68%
                        <br />• イベント終盤（80-89%）: ±10%誤差範囲の的中率 56-81%、±5%誤差範囲 56-81%
                        <br />• イベント最終盤（90-97%）: ±10%誤差範囲の的中率 87-100%、±5%誤差範囲 81-100%
                    </p>
                    <p className="mt-2">
                        <strong>2500位ボーダー:</strong>
                        <br />• イベント序盤（10-29%）: ±10%誤差範囲の的中率 31-69%、±5%誤差範囲 31-69%
                        <br />• イベント中盤（30-69%）: ±10%誤差範囲の的中率 43-68%、±5%誤差範囲 43-68%
                        <br />• イベント後半（70-79%）: ±10%誤差範囲の的中率 50-75%、±5%誤差範囲 50-75%
                        <br />• イベント終盤（80-89%）: ±10%誤差範囲の的中率 81-93%、±5%誤差範囲 81-93%
                        <br />• イベント最終盤（90-97%）: ±10%誤差範囲の的中率 93-100%、±5%誤差範囲 93-100%
                    </p>
                </div>
                <div className="mt-6">
